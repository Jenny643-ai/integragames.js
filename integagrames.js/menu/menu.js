...
const menuLateral = require('../menu/menuLateral');
const barraSuperior = require('../menu/barraSuperior');
const encabezado = require('../menu/encabezado');
const piePagina = require('../menu/piePagina');
const logoutModal = require('../menu/logoutModal');
